...
- Formal repo-wide workflow protocols live under `docs/workflow/*`.
...
- After completing a durable task, explicitly check whether any stable pattern or gotcha should be written to project memory. If yes → update `memory/patterns.md`, `memory/gotchas.md`, or `memory/MEMORY.md`.
